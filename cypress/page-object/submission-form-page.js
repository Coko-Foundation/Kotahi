...
export const SubmissionFormPage = {
    ...
    fillInTitle(title) {
        this.getTitleField().cy.fillInput(title);
    },
    getNameField() {
    ...
    fillReferences(references) {
        this.getReferencesField().fillInput(references);
    },
