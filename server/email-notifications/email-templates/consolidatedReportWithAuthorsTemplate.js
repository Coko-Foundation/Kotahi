  ...
  result.content = `<p>
      ...
      <ol>
        ...
        <li>
          ...
          <p>We would naturally be happy to post your response to the reviewers’ comments alongside the consolidated report on both bioRxiv and Sciety; simply provide your response in the XXX field after logging in to our platform (${appUrl}) and we will post it at the first opportunity.</p>
        </li>
        <li>
