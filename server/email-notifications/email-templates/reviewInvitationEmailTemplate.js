  ...
  switch (instance) {
    ...
    case 'colab':
      ...
      result.content = `
        ...
        <p>We are currently reviewing the recent preprint by ${authorName} and colleagues (<a href="${submissionLink}">${submissionLink}</a>), following the authors’ approval. Providing you have no potential conflicts of interest, which might include reviewing this work for a traditional journal, we’re hoping you’ll be available to review the preprint for Biophysics Colab within the next two weeks. We would ask you to follow the guidelines below when formulating your feedback then participate in a discussion with the other reviewers to consolidate the various advice into a single report. With the authors’ permission, we will post this consolidated feedback on their bioRxiv publication, and highlight the work and our feedback on eLife’s <a href="https://www.sciety.org/groups/biophysics-colab" target="_blank">Sciety</a> platform.</p>
