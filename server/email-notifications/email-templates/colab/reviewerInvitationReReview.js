const ColabReviewerInvitationReReview = ({
  ...
  result.content = `<p>
      ...
      <p>Thank you for sharing your time and expertise during your recent review of the preprint “${preprintName}”.</p>
      <p>After carefully considering our advice, the authors have published a revised preprint in bioRxiv (which is available at ${preprintUrl}) and submitted a response to the various comments in our report (which I have appended here).</p>
      <p>I’d be interested to hear your thoughts on the appropriateness of the authors’ response and whether you feel the conclusions in the revised preprint are robust and therefore suitable for endorsement by Biophysics Colab. I’d be grateful if you could convey your opinion by simply replying to this message.</p>
