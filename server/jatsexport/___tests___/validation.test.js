...
// this is not a test per se – it is a quick way for devs to test whether strings of jats are valid according to the schema
// without pulling the full kotahi up (or while making changes to kotahi's jats exporting functionality.
// (maybe it would be good to turn this into an actual test as well?)
//
// to run this:
//
// node server/jatesport/validation.test.js
//
// It runs a correct string of JATS through to check that the parse is working, then one that will fail. There are a lot of ways for JATS to fail!

// // eslint-disable-next-line
// console.log(
//   '\n\n\nValidating the correct JATS (nothing will be logged if it passes):',
// )
// validateJats(correctJats)

// // eslint-disable-next-line
// console.log('\n\n\nValidating incorrect JATS:')
// validateJats(incorrectJats)
