  ...
  translation: {
    ...
    configPage: {
      ...
      emailNotification: {
        ...
        pass: 'Пароль',
        fromDescription:
          'Адрес электронной почты отправителя, отображаемый для получателя. Обратите внимание, что, возможно, вам также нужно будет настроить этот адрес в параметрах вашего почтового провайдера.',
