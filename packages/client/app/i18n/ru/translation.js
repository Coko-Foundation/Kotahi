  ...
  translation: {
    ...
    cmsPage: {
      ...
      layout: {
        ...
        draftModeWarning:
          'Включение режима черновика сделает ваш рабочий сайт временно недоступным, пока Flax перестраивает сайт. Ваш сайт останется недоступным, пока режим черновика не будет снова отключен.',
        MakeFlaxSitePrivate:
