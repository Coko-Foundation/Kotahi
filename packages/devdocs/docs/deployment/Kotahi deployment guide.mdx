...
major version of docker (version 29 as of this writing). This could be a linux 
...
- Click on generate my ID and secret
...
To deploy Flax, simply run the [`cokoapps/kotahi-flax`](https://hub.docker.com/r/cokoapps/kotahi-flax/tags)
...
- Send a message to [eLife Pathways](https://elifepathways.org/#get-involved)
- If you think you've found a bug, or that these docs are incorrect in some way, 
open a GitHub issue in [Kotahi's GitHub repo](https://github.com/eLifePathways/Kotahi/issues/).
